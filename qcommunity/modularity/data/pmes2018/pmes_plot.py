...
def two_figures():
    ...
    dwavefile = 'expr_dwave2.txt'
    gurobifile = 'expr_gurobi.txt'
    qaoafile = 'qaoa.csv'
    ...
    for line in myfile:
        ...
        ls2 = ls[1].split(',')
        mod = 0.25 * float(ls2[-2]) / graphInfo[graphname]['edges']
        it = int(ls2[-1])
    ...
    plt.plot([], c=qaoa_color, linewidth=4, label='QAOA')
...
def one_figure():
    ...
    ax1.plot([], c=qaoa_color, linewidth=4, label='QAOA')
    ...
    ax2.plot([], c=qaoa_color, linewidth=4, label='QAOA')
